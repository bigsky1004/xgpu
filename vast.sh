...
sudo git clone https://github.com/bigsky1004/XENGPUMiner.git > /dev/null 2>&1
echo "STEP 6 of 10: Cloned https://github.com/bigsky1004/XENGPUMiner.git"
...
sudo sed -i 's/account = 0xe8cdcEB04fC07979B4C4Cd46a09F140f82750cD0/account = 0xe8cdcEB04fC07979B4C4Cd46a09F140f82750cD0/g' config.conf > /dev/null 2>&1
